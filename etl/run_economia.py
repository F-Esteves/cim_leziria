...
def correr_passo(nome: str) -> bool:
    ...
    if nome == "extract":
        from etl.extract_economia import main
    elif nome == "transform":
        from etl.transform_economia import main
    elif nome == "validate":
        from etl.validate_economia import main
    elif nome == "load":
        from etl.load_economia import main
    else:
...
def main():
    ...
    print(f"\n{'='*55}")
    print(f"  CIM Lezíria do Tejo · Cluster 5 — Economia")
