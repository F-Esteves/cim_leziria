...
def correr_passo(nome: str) -> bool:
    ...
    if nome == "extract":
        from etl.extract_mobilidade import main
    elif nome == "transform":
        from etl.transform_mobilidade import main
    elif nome == "validate":
        from etl.validate_mobilidade import main
    elif nome == "load":
        from etl.load_mobilidade import main
    else:
...
def main():
    ...
    print(f"\n{'='*55}")
    print(f"  CIM Lezíria do Tejo · Cluster 3 — Mobilidade")
