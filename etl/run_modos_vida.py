...
def correr_passo(nome: str) -> bool:
    ...
    if nome == "extract":
        from etl.extract_modos_vida import main
    elif nome == "transform":
        from etl.transform_modos_vida import main
    elif nome == "validate":
        from etl.validate_modos_vida import main
    elif nome == "load":
        from etl.load_modos_vida import main
    else:
...
def main():
    ...
    print(f"\n{'='*55}")
    print(f"  CIM Lezíria do Tejo · Cluster 4 — Modos de Vida")
